 ...
 *
 * @link http://help.tave.com/getting-started/contact-forms/using-contact-form-7
...
class Tave_CF7 {
  ...
  public function send_data()
  {
    ...
    else if (wp_remote_retrieve_response_code( $response ) == 200 && trim(wp_remote_retrieve_body( $response )) == 'OK') {
