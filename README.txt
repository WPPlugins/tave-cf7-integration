...
For complete help details see the [Support Site](http://help.tave.com/getting-started/contact-forms/using-contact-form-7)

== Installation ==

Install [Contact Form 7](http://wordpress.org/extend/plugins/contact-form-7/)
...
See the [Support Site](http://help.tave.com/getting-started/contact-forms/using-contact-form-7) for a more detailed explanation.
